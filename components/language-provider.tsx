...
const translations = {
  ar: {
    ...
    clients: "عملاؤنا",
    contact: "اتصل بنا",
    "hero.title": "مصنع الألمنيوم المتميز",
    ...
    "footer.address": "العنوان: المنطقة الصناعية، الرياض، المملكة العربية السعودية",
    "footer.phone": "الهاتف: +966 12 345 6789",
  ...
  en: {
    ...
    clients: "Our Clients",
    contact: "Contact Us",
    "hero.title": "Premium Aluminum Factory",
    ...
    "footer.address": "Address: Industrial Area, Riyadh, Saudi Arabia",
    "footer.phone": "Phone: +966 12 345 6789",
