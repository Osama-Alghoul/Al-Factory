...
export const metadata: Metadata = {
  ...
  description: 'موقع مصنع الألمنيوم المتخصص في تصنيع منتجات الألومنيوم عالية الجودة',
  keywords: ['ألومنيوم', 'مصنع ألومنيوم', 'جدة', 'السعودية', 'UPAL Systems',
    'منتجات ألومنيوم', 'حلول ألومنيوم', 'تصميم ألومنيوم', 'تركيب ألومنيوم',
    'قطاعات الألمنيوم المعمارية', 'أبواب وشبابيك ألومنيوم', 'واجهات زجاجية ألومنيوم',
    'أسقف ألومنيوم', 'حوائط ستائرية ألومنيوم', 'برجولات ألومنيوم',
    'تصميم حسب الطلب', 'تنفيذ مشاريع', 'تركيب وصيانة', 'صناعات معدنية', 'تصميم وتنفيذ',],
  robots: {
    index: true,
    follow: true,
  },
